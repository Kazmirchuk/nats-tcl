...
Regarding the NATS server version, all tests pass against v2.14. "Core NATS" tests (auth.test, basic.test, extra_opts.test, server_pool.test, subjects_regex.test, tls.test) also pass against NATS v1.4.1. Of course, JetStream and message headers require NATS 2.2+.
